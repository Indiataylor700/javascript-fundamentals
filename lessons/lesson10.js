/*  Lesson 10 - Map and Set Collections */
...
function exampleDelete(){
    ...
    console.log(`Removing combo ${remove} & gluten free ${remove2}`);
    console.log(`The new numbe of pizza specials is ${pizzaSpecials.size}`);
}
...
function exampleEntries() {
   ...
   // console.log(values);for(let num = 0; num < values; num++) {
...
/* Create a set and get it's size */
...
Callback function uses three parameters
(value, key, set)
*/
...
/* Union method takes a set
and returns a new set containing
elements of both */
...
based on the intersection of two sets */
