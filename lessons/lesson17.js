...
/* Reference Errors - Try to access a variable
...
/* Sytax error - Missing a syntax in the code */
//console.log('Hello, JavaScript';

/* Range error - when a value is
out of range, like passing an invalid number */
