...
Global means everyone can see it vs local, 
which is contained within function scope. */
...
using and anonymous function with a nested 
fuction */
const addFive = function() {
    let total = 0;
    return function() {total += 5;
        // total = total + 5
        return total;
    }
}();
...
//console.log(subtractMe(34));

/* Rest Parameter - Allows for indefinite number of 
arguments as an array (group of data) */
...
/* Arrow functions are a compact version of a 
function expression */
...
const div3Arrow = () => 10 + 5 / 3;

//console.log(div3());
//console.log(div3Arrow());
...
const addTheseArrow = (value1, ...args) => value1 * args[0]
