...
/* Update an array by it's element position */
...
/* Join and Slice instance methods */
/* Join returns a concatenated string, including 
a separator */
...
function truckSliceExample() {
    const truck2026 = trucks.slice(0,2);
    truck2026.forEach(function truckResult(results){
        console.log(results);
    });
}
//truckSliceExample();
...
/* Pop method will remove the last
...
/* Reverse and Shift Methods */
/* Reverse will change the order of the
elements in the opposite direction.
The will permanently change the array. */
