...
-Instance String methods and properties are accessible through the primitve using dot notation.
...
- Entering a number value within the [] provides us with the character at that position.
...
- The \ backslash allows the string to use its original defined single or double quotes.
...
- They are also used with placeholder text.
...
### Escape Sequences
- Some cases where you need to use characters that are normally reserved.
