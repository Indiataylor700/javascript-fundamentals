...
- There are four number systems that exists
     ...
     - Octal: A base 8 system that conssits of 0-7 values and is prefixed with 0o or 0O.
...
- It uses a format called beN
    - b is a number
    - e or E is the based number(exponent)
    - N is the value of the exponent
- The N determines which directon the decimal point can be moved in a given number set.
    - -N means the decimal point moves to the left.
    - +N means the decimal point moves to the right.
    - Any empty spaces during the move are replaced wth a 0.
...
- Cannot be used between a prefix of a numeric system, the end of a value, or next to the decimal point.

### Number Object
- Has a set of method and properties; Static and Instance.
...
### BigInt Object
- Has a set of methods both static and instance
